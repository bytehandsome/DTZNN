...
% 
function [H1,H2,H3] = plot3_fewer_markers(x, y, z, num_Markers, varargin)
...
H2 = plot3(x, y, z, varargInNoMk{:});                               %no markers here
...
zi = z(ti);
hold on;
H3 = plot3(xi,yi,zi,varargInNoMkNoLn{:},'Marker',lm,'MarkerSize',ms,'MarkerFaceColor',mfc,'LineStyle','none');  %plot markers only
...
if strcmp(LegendLine,'on')
    H1 = plot3(xi(1),yi(1),zi(1),varargInNoMk{:},'Marker',lm,'MarkerSize',ms,'MarkerFaceColor',mfc);
else
    H1 = plot3(xi(1),yi(1),zi(1),varargInNoMk{:},'linestyle','none','Marker',lm,'MarkerSize',ms,'MarkerFaceColor',mfc);
end
